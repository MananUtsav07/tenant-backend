...
const envSchema = z.object({
  ...
  AWS_S3_DOCUMENTS_PREFIX: optionalNonEmptyString,
  AWS_S3_PUBLIC_BASE_URL: optionalNonEmptyString,
  ...
  WHATSAPP_PROVIDER: z.enum(['stub', 'meta', 'twilio']).optional(),
  WHATSAPP_ACCESS_TOKEN: optionalNonEmptyString,
  WHATSAPP_PHONE_NUMBER_ID: optionalNonEmptyString,
  WHATSAPP_BUSINESS_ACCOUNT_ID: optionalNonEmptyString,
  ...
  TWILIO_WHATSAPP_NUMBER: optionalNonEmptyString,
