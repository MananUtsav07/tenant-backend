...
import { findAdminByEmail, getAdminOrganizationDetail, listAdminOrganizations, getAdminById, getAdminDashboardSummary, getSystemHealthMetrics, listAdminAnalytics, listAdminContactMessages, listAdminOwners, listAdminProperties, listAdminTenants, listAdminTickets, } from '../services/adminService.js';
...
import { adminAnalyticsListQuerySchema, adminContactMessageListQuerySchema, adminLoginSchema, adminOwnerListQuerySchema, adminPropertyListQuerySchema, adminTenantListQuerySchema, adminTicketListQuerySchema, adminOrganizationListQuerySchema, } from '../validations/adminSchemas.js';
import { adminBlogListQuerySchema, createBlogPostSchema, updateBlogPostSchema } from '../validations/blogSchemas.js';
function requireAdminId(request) {
...
function readPathId(request, paramName) {
...
async function trackAdminAnalyticsSafe(input) {
    try {
...
export const adminMe = asyncHandler(async (request, response) => {
...
export const getAdminOwners = asyncHandler(async (request, response) => {
...
export const getAdminTenants = asyncHandler(async (request, response) => {
...
export const getAdminProperties = asyncHandler(async (request, response) => {
...
export const getAdminTickets = asyncHandler(async (request, response) => {
...
export const getAdminContactMessages = asyncHandler(async (request, response) => {
...
export const getAdminSystemHealth = asyncHandler(async (_request, response) => {
...
export const getAdminAiStatus = asyncHandler(async (_request, response) => {
...
export const getAdminOrganizations = asyncHandler(async (request, response) => {
...
export const getAdminOrganizationById = asyncHandler(async (request, response) => {
...
export const getAdminBlogPosts = asyncHandler(async (request, response) => {
...
export const postAdminBlogPost = asyncHandler(async (request, response) => {
    const adminId = requireAdminId(request);
...
export const putAdminBlogPost = asyncHandler(async (request, response) => {
    const adminId = requireAdminId(request);
...
export const deleteAdminBlogPostById = asyncHandler(async (request, response) => {
    const adminId = requireAdminId(request);
    const postId = readPathId(request, 'id');
