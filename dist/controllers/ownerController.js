...
import { createProperty, createTenant, deleteProperty, deleteTenant, getOwnerDashboardSummary, getPropertyForOwner, getTenantDetailAggregate, listOwnerNotifications, listOwnerTickets, listProperties, listTenants, markNotificationRead, updateOwnerTicket, updateProperty, updateTenant, } from '../services/ownerService.js';
...
export const createOwnerProperty = asyncHandler(async (request, response) => {
...
export const getOwnerProperties = asyncHandler(async (request, response) => {
...
export const patchOwnerProperty = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
...
export const removeOwnerProperty = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
    const propertyId = readPathId(request, 'id');
...
export const createOwnerTenant = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
...
export const getOwnerTenants = asyncHandler(async (request, response) => {
    const organizationId = requireOrganizationContext(request);
    const tenants = await listTenants(organizationId);
    response.json({ ok: true, tenants });
});
export const getOwnerTenantById = asyncHandler(async (request, response) => {
    const organizationId = requireOrganizationContext(request);
...
export const patchOwnerTenant = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
    const tenantId = readPathId(request, 'id');
...
export const removeOwnerTenant = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
    const tenantId = readPathId(request, 'id');
...
export const getOwnerTicketList = asyncHandler(async (request, response) => {
    const organizationId = requireOrganizationContext(request);
    const tickets = await listOwnerTickets(organizationId);
    response.json({ ok: true, tickets });
});
export const patchOwnerTicket = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
...
export const getOwnerNotificationList = asyncHandler(async (request, response) => {
    const organizationId = requireOrganizationContext(request);
    const notifications = await listOwnerNotifications(organizationId);
    response.json({ ok: true, notifications });
});
export const markOwnerNotificationRead = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
...
export const getOwnerSummary = asyncHandler(async (request, response) => {
    const organizationId = requireOrganizationContext(request);
    const summary = await getOwnerDashboardSummary(organizationId);
    response.json({ ok: true, summary });
});
export const processReminders = asyncHandler(async (request, response) => {
    const { ownerId, organizationId } = requireOwnerContext(request);
