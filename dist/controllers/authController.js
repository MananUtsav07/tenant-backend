...
export const registerOwner = asyncHandler(async (request, response) => {
...
export const loginOwner = asyncHandler(async (request, response) => {
...
export const ownerMe = asyncHandler(async (request, response) => {
...
export const loginTenant = asyncHandler(async (request, response) => {
...
export const tenantMe = asyncHandler(async (request, response) => {
