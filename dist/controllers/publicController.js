...
export const postPublicContactMessage = asyncHandler(async (request, response) => {
...
export const postPublicAnalyticsEvent = asyncHandler(async (request, response) => {
...
export const getPublicSnapshot = asyncHandler(async (_request, response) => {
