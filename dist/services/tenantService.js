...
export async function findTenantByAccessId(tenantAccessId) {
...
export async function getTenantById(tenantId, organizationId) {
...
export async function getTenantSummary(tenantId, organizationId) {
...
export async function listTenantTickets(tenantId, organizationId) {
    const { data, error } = await supabaseAdmin
        .from('support_tickets')
        .select('*')
        .eq('organization_id', organizationId)
...
export async function getOwnerContactByTenant(tenantId, organizationId) {
...
export async function listAllTenantsForOrganization(organizationId) {
...
export async function markReminderAsSent(reminderId, organizationId) {
    const { data, error } = await supabaseAdmin
        .from('rent_reminders')
